...
const segments = [
  {
    ...
    accent: "#c4a882",
    accentBg: "rgba(196,168,130,0.06)",
    accentBorder: "rgba(196,168,130,0.2)",
  },
  {
    emoji: "🤝",
    ...
    accentBorder: "rgba(196,168,130,0.15)",
  },
  {
    emoji: "🌴",
  ...
  },
  {
    ...
    accentBorder: "rgba(196,168,130,0.12)",
  },
];
          ...
          {segments.map((seg, i) => (
            <TiltCard key={seg.tag} className={`reveal reveal-delay-${i + 1}`}>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-[#f5f2ee] mb-3 tracking-tight leading-snug">
                  {seg.headline}
                </h3>
