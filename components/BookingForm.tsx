...
export default function BookingForm() {
  ...
  return (
    ...
    >
      {/* Warm aurora glow behind form */}
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse 60% 60% at 50% 50%, rgba(196,168,130,0.10) 0%, transparent 70%)",
          filter: "blur(40px)",
        }}
      />
      ...
      <div className="relative z-10 max-w-lg mx-auto">
        <div className="text-center mb-12 reveal">
          ...
          <h2
            className="font-display font-light text-[#f5f2ee] tracking-tight mb-4"
        ...
        {status === "success" ? (
          <div className="rounded-2xl p-12 text-center glass-card reveal">
            <div
              ...
              style={{
                ...
                boxShadow: "0 0 30px rgba(196,168,130,0.15)",
                color: "#c4a882",
              }}
            >
              ✓
            </div>
            <h3 className="text-xl font-semibold text-[#f5f2ee] mb-2">
          ...
          >
            {[
              ...
              <div key={field.name}>
                ...
                <input
                  ...
                  className="w-full rounded-xl px-4 py-3.5 text-sm text-[#f5f2ee] outline-none transition-all"
                  style={{
                    background: "rgba(196,168,130,0.03)",
                    border: "1px solid rgba(196,168,130,0.12)",
                  }}
                  onFocus={(e) => {
                    e.target.style.borderColor = "rgba(196,168,130,0.55)";
                    e.target.style.boxShadow = "0 0 0 3px rgba(196,168,130,0.08)";
                    e.target.style.background = "rgba(196,168,130,0.05)";
                  }}
                  onBlur={(e) => {
                    e.target.style.borderColor = "rgba(196,168,130,0.12)";
                    e.target.style.boxShadow = "none";
                    e.target.style.background = "rgba(196,168,130,0.03)";
                  }}
                />
              </div>
            ))}
            ...
            <button
              ...
              className="w-full disabled:opacity-50 font-semibold py-4 rounded-full transition-all mt-2"
              style={{
                background: "#c4a882",
                color: "#090909",
                boxShadow: "0 0 30px rgba(196,168,130,0.3)",
              }}
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLElement).style.background = "#d4bc9a";
                (e.currentTarget as HTMLElement).style.boxShadow = "0 0 50px rgba(196,168,130,0.5)";
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLElement).style.background = "#c4a882";
                (e.currentTarget as HTMLElement).style.boxShadow = "0 0 30px rgba(196,168,130,0.3)";
              }}
            >
              {status === "loading" ? "Sending…" : "Book My Scan →"}
            </button>

            <p className="text-center text-xs" style={{ color: "#3d3b38" }}>
